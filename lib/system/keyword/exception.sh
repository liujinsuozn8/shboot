...
alias try='[ -z "$___in_try_catch___" ] && export ___in_try_catch___=0 && __init_exception_cache; ((___in_try_catch___+=1)); export ___setOps___="$-"; set +e; (set -e; addTrap "__saveGlobalVar" EXIT INT ABRT; exec 2> "$__boot_exception_cache";'
